...
# Get the producer ID from environment variable or default to "2"
producer_id = os.getenv("PRODUCER_ID", "2")
...
try:
    ...
    while True:
        ...
        event = {
            ...
            "anomaly_score": round(randint(70, 100)/100, 2), # More critical anomalies
            "status": "anomaly",
            "timestamp": time.time()
        }
